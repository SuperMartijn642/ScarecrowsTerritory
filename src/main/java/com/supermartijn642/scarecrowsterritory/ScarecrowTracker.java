...
public class ScarecrowTracker {
    ...
    public static void registerListeners(){
        ServerTickEvents.END_LEVEL_TICK.register(SERVER::onWorldTick);
        ServerLevelEvents.UNLOAD.register((server, level) -> SERVER.onWorldUnload(level));
        ServerChunkEvents.CHUNK_LOAD.register((level, chunk, _) -> SERVER.onChunkLoad(level, chunk));
