...
public class ScarecrowTracker {
    ...
    public static void registerListeners(){
        MinecraftForge.EVENT_BUS.addListener((Consumer<MobSpawnEvent.AllowDespawn>)e -> {
        ...
        MinecraftForge.EVENT_BUS.addListener((Consumer<TickEvent.LevelTickEvent.Post>)e -> get(e.level).onWorldTick(e.level));
        MinecraftForge.EVENT_BUS.addListener((Consumer<LevelEvent.Unload>)e -> {
